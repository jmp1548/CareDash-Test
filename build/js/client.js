...
/***/ (function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  var stringCompare = function stringCompare(string1, string2) {
	    if (string1 === string2) {
	      return true;
	    }
	  ...
	  //get label for input
	  var getLabel = function getLabel(elem) {
	  ...
	  document.querySelector('.i-form').addEventListener('submit', function (e) {
	    ...
	    e.preventDefault();
	    var firstName = e.target.querySelector('#first-name');
	    var lastName = e.target.querySelector('#last-name');
	    var email = e.target.querySelector('#email');
	    var password = e.target.querySelector('#password');
	    var confirmPassword = e.target.querySelector('#confirm-password');
